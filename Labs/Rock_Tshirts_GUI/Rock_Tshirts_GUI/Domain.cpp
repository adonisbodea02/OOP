...
std::string Rock_Tshirt::to_string()
{
	std::string s = "";
	s += std::to_string(ID) + " " + size + " " + colour + " " + std::to_string(price) + " " + std::to_string(quantity) + " " + formation;
	return s;
}

std::string Rock_Tshirt::to_short_string()
{
	std::string s = "";
	s += std::to_string(ID) + " " + size + " " + colour + " " + formation;
	return s;
}
